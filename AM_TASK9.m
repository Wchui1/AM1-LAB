...
wopt3=fpoc(Sj)*Sd1;
yt3=0.22*wopt3'*X_im;
displayimage(yt3, image_size, 203,'The received signal at o/p of superresolution beamformer 30 degrees');
Z=pattern1(array, wopt3);
plot2d3d(Z, 0:180,0,'gain in dB','superresolution array pattern 30 degrees');
...
figure()
plot(1:length(err_lms),abs(err_lms))
